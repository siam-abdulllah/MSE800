...
<body>
<h1 style="color: white;">Welcome to my Flask project</h1>
{content}
</body>
</html>
"""
...
def learning(name):
    return page(
        ...
        f'<a style="color: pink;" href="https://blackboard.up.education/ultra/courses/_9035_1/cl/outline">Flask content link.</a>'
    )
